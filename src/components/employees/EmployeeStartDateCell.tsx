...
export function EmployeeStartDateCell({
  ...
  return (
    <div className="min-w-[8.5rem] space-y-1">
        ...
        {offerLetter && (
          <>
            <button
              ...
              className="max-w-[5rem] truncate text-[10px] text-accent hover:underline"
      ...
      {uploadHint && <p className="text-[10px] leading-snug text-muted">{uploadHint}</p>}
      {!uploadHint && offerLetter && (
        <p className="truncate text-[10px] text-muted" title={offerLetter.fileName}>
